...
<div className="relative overflow-hidden bg-gradient-to-r from-indigo-600 to-purple-600 rounded-3xl p-12 text-center text-white shadow-2xl">
...
Talk with our support team for personalized help.
</p>
...
className="inline-block bg-white text-indigo-600 px-10 py-4 rounded-xl font-semibold hover:bg-indigo-50 transition shadow"
>
